...
function DynamicCam:GetDefaultSituations()
    ...
    -- load a table full of the names for both key and value
    for name, importString in pairs(defaults) do
