...
L["<standardSettingsOverridden_desc>"] = "Blau markierte Kategorien werden momentan durch die aktive Situation überschrieben. Änderungen der Standard-Einstellungen haben somit keinen sichtbaren Effekt, solange die überschreibende Situation aktiv ist."
L["Currently overridden by the active situation %s."] = "Momentan überschrieben durch die aktive Situation %s."
L["Situation disabled."] = "Situation deaktiviert."
L["Situation enabled but condition not fulfilled."] = "Situation aktiviert, aber Bedingung nicht erfüllt."
L["Situation has a script error."] = "Situation hat einen Skriptfehler."
L["Help"] = "Hilfe"
L["Detach"] = "Ablösen"
...
L["<opacity_tooltip>"] = "Die Deckkraft dieses Fensters erhöhen, um es besser lesen zu können."
L["WARNING"] = "WARNUNG"
...
L["<selectedSituation_desc>"] = "\n%sFarbcodes:%s\n%s- Deaktivierte Situation.%s\n%s- Aktivierte, aber momentan inaktive Situation.%s\n%s- Aktivierte und momentan aktive Situation.%s\n%s- Aktivierte Situation mit erfüllter Bedingung, aber niedrigerer Priorität als die momentan aktive Situation.%s\n%s- Modifizierte Original-„Situations-Steuerung“ (Zurücksetzen empfohlen).%s\n%s- Fehlerhafte „Situations-Steuerung“ (Korrektur erforderlich).%s"
...
L["Z\no\no\nm"] = "Z\no\no\nm"
L["Value"] = "Wert"
L["Current Zoom/Value:"] = "Aktueller Zoom/Wert:"
L["Left-click: add/drag point\nRight-click: remove point"] = "Linksklick: Punkt hinzufügen/ziehen\nRechtsklick: Punkt entfernen"
L["Copy"] = "Kopieren"
L["<copy_tooltip>"] = "Diese Kurve in die Zwischenablage kopieren. Sie kann dann in jeden anderen Kurveneditor eingefügt werden und wird automatisch auf den Zielwertebereich skaliert."
L["Paste"] = "Einfügen"
L["<paste_tooltip>"] = "Diese Kurve durch die Kurve aus der Zwischenablage ersetzen, skaliert auf den Wertebereich dieser Einstellung."
L["<paste_disabled_tooltip>"] = "Keine Kurve in der Zwischenablage. Verwende zuerst Kopieren in einem Kurveneditor."
L["Revert"] = "Zurück"
L["<revert_tooltip>"] = "Die Kurve auf den letzten gespeicherten Zustand zurücksetzen."
L["<revert_disabled_tooltip>"] = "Keine ungespeicherten Änderungen zum Zurücksetzen."
L["Save"] = "Speichern"
L["<save_tooltip>"] = "Die aktuelle Kurve speichern. Ungespeicherte Änderungen gehen beim Schließen des Editors verloren."
