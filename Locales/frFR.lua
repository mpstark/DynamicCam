...
L["<standardSettingsOverridden_desc>"] = "Les catégories marquées en bleu sont actuellement ignorées par la situation active. Vous ne verrez donc aucun effet si vous modifiez les Paramètres Standard des catégories bleues tant que la situation qui les remplace est active."
L["Currently overridden by the active situation %s."] = "Actuellement ignoré par la situation active %s."
L["Situation disabled."] = "Situation désactivée."
L["Situation enabled but condition not fulfilled."] = "Situation activée mais condition non remplie."
L["Situation has a script error."] = "La situation a une erreur de script."
L["Help"] = "Aide"
L["Detach"] = "Détacher"
L["<detach_tooltip>"] = "Ouvre les paramètres de DynamicCam dans une fenêtre librement déplaçable et redimensionnable. Ainsi, elle ne bloque pas le centre de l'écran pendant vos réglages.\n\nVous pouvez aussi taper /dc dans le chat à tout moment pour ouvrir cette fenêtre."
L["<detach_combat>"] = "En combat, nous ne pouvons pas fermer automatiquement le panneau des Options du jeu.\n\nVous pouvez toujours ouvrir la fenêtre détachée en tapant /dc dans le chat."
L["Reattach"] = "Rattacher"
L["<reattach_tooltip>"] = "Ferme cette fenêtre et ouvre les paramètres de DynamicCam dans le panneau d'options du jeu."
L["<reattach_combat>"] = "En combat, nous ne pouvons pas ouvrir automatiquement le panneau des Options du jeu."
L["Increase opacity"] = "Augmenter l'opacité"
L["<opacity_tooltip>"] = "Augmente l'opacité de cette fenêtre pour une meilleure lisibilité."
L["WARNING"] = "ATTENTION"
...
L["The camera's field of view. Lower values are more zoomed in, higher values show more of your surroundings."] = "Le champ de vision de la caméra. Les valeurs basses zooment davantage, les valeurs élevées affichent une plus grande partie de votre environnement."
L["<cameraFov_desc>"] = "Le champ de vision (FOV) détermine la portion du monde du jeu visible simultanément à l'écran. Un champ de vision plus élevé montre davantage votre environnement mais donne l'impression que tout est un peu plus éloigné, tandis qu'un champ de vision plus faible zoome pour une sensation de proximité plus cinématographique.\n\nEn utilisant les situations de DynamicCam, vous pouvez par exemple élargir le champ de vision lors de vos déplacements et le réduire lors des interactions avec les PNJ ou en combat."
...
L["<selectedSituation_desc>"] = "\n%sCodes couleurs :%s\n%s- Situation désactivée.%s\n%s- Situation activée mais actuellement inactive.%s\n%s- Situation activée et actuellement active.%s\n%s- Situation activée avec condition remplie mais priorité inférieure à la situation actuellement active.%s\n%s- « Contrôle de situation » d'origine modifié (réinitialisation recommandée).%s\n%s- « Contrôle de situation » erroné (correction requise).%s"
...
L["Z\no\no\nm"] = "Z\no\no\nm"
L["Value"] = "Valeur"
L["Current Zoom/Value:"] = "Zoom/Valeur actuelle :"
L["Left-click: add/drag point\nRight-click: remove point"] = "Clic gauche : ajouter/glisser point\nClic droit : retirer point"
L["Copy"] = "Copier"
L["<copy_tooltip>"] = "Copier cette courbe dans le presse-papiers. Elle peut ensuite être collée dans un autre éditeur de courbe, en s'adaptant automatiquement à la plage de valeurs cible."
L["Paste"] = "Coller"
L["<paste_tooltip>"] = "Remplacer cette courbe par celle du presse-papiers, adaptée à la plage de valeurs de ce réglage."
L["<paste_disabled_tooltip>"] = "Aucune courbe dans le presse-papiers. Utilisez d'abord Copier dans un éditeur de courbe."
L["Revert"] = "Rétablir"
L["<revert_tooltip>"] = "Rétablir la courbe au dernier état sauvegardé."
L["<revert_disabled_tooltip>"] = "Aucune modification non sauvegardée à rétablir."
L["Save"] = "Sauver"
L["<save_tooltip>"] = "Sauvegarder la courbe actuelle. Les modifications non sauvegardées sont perdues à la fermeture de l'éditeur."
L["<save_disabled_tooltip>"] = "Aucune modification non sauvegardée."
L["Close"] = "Fermer"
L["<close_tooltip>"] = "Fermer l'éditeur. Toutes les modifications non sauvegardées seront perdues."
