...
L["<standardSettingsOverridden_desc>"] = "파란색으로 표시된 범주는 현재 활성 상황에 의해 재정의됩니다. 따라서 재정의하는 상황이 활성화된 동안에는 파란색 범주의 기본 설정을 변경해도 효과가 나타나지 않습니다."
L["Currently overridden by the active situation %s."] = "현재 활성 상황에 의해 재정의됨 %s."
L["Situation disabled."] = "상황 비활성화됨."
L["Situation enabled but condition not fulfilled."] = "상황이 활성화되었지만 조건이 충족되지 않았습니다."
...
L["<detach_combat>"] = "전투 중에는 게임의 옵션 패널을 자동으로 닫을 수 없습니다.\n\n채팅에 /dc를 입력하면 언제든지 분리된 창을 열 수 있습니다."
L["Reattach"] = "다시 붙이기"
L["<reattach_tooltip>"] = "이 창을 닫고 게임의 옵션 패널에서 DynamicCam 설정을 엽니다."
L["<reattach_combat>"] = "전투 중에는 게임의 옵션 패널을 자동으로 열 수 없습니다."
L["Increase opacity"] = "불투명도 높이기"
L["<opacity_tooltip>"] = "가독성을 높이기 위해 이 창의 불투명도를 높입니다."
L["WARNING"] = "경고"
...
--------------------------------------------------------------------------------
L["Field of View"] = "시야"
L["The camera's field of view. Lower values are more zoomed in, higher values show more of your surroundings."] = "카메라의 시야입니다. 값이 낮을수록 화면이 확대되고, 값이 높을수록 주변 환경이 더 많이 보입니다."
L["<cameraFov_desc>"] = "시야(FOV)는 화면에 한 번에 표시되는 게임 세계의 범위를 결정합니다. 시야가 넓으면 주변 환경이 더 많이 보이지만 모든 것이 조금 더 멀리 있는 것처럼 보이며, 시야가 좁으면 더 영화 같고 가까운 느낌을 줍니다.\n\nDynamicCam의 상황 기능을 사용하면, 예를 들어 돌아다닐 때는 시야를 넓히고 NPC 상호작용이나 전투 중에는 시야를 좁힐 수 있습니다."
...
L["<selectedSituation_desc>"] = "\n%s색상 코드:%s\n%s- 비활성화된 상황.%s\n%s- 활성화되었지만 현재 비활성 상태인 상황.%s\n%s- 활성화되었으며 현재 활동 중인 상황.%s\n%s- 활성화되었고 조건이 충족되었지만 현재 활동 중인 상황보다 우선 순위가 낮은 상황.%s\n%s- 수정된 원본 \"상황 제어\" (초기화 권장).%s\n%s- 오류가 있는 \"상황 제어\" (수정 필요).%s"
