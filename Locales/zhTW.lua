local L = LibStub("AceLocale-3.0"):NewLocale("DynamicCam", "zhTW") if not L then return end
...
L["<standardSettingsOverridden_desc>"] = "藍色的類型表示目前被啟動的情境覆蓋。因此，在覆蓋情境啟動時，藍色類型的標準設定不會生效。"
L["Currently overridden by the active situation %s."] = "目前被啟動的情境覆蓋 %s."
L["Situation disabled."] = "情境已停用。"
L["Situation enabled but condition not fulfilled."] = "情境已啟動但條件未滿足。"
L["Situation has a script error."] = "情境存在腳本錯誤。"
L["Help"] = "幫助"
L["Detach"] = "分離"
L["<detach_tooltip>"] = "在一個可自由移動、可調整大小的視窗中開啟 DynamicCam 設定。這樣在調整設定時不會遮擋螢幕中央。\n\n您也可以隨時在聊天中輸入 /dc 來開啟此視窗。"
L["<detach_combat>"] = "戰鬥中，我們無法自動關閉遊戲的選項面板。\n\n您可以隨時在聊天中輸入 /dc 來開啟分離視窗。"
L["Reattach"] = "重新附加"
L["<reattach_tooltip>"] = "關閉此視窗，並在遊戲的選項面板中開啟 DynamicCam 設定。"
L["<reattach_combat>"] = "戰鬥中，我們無法自動開啟遊戲的選項面板。"
L["Increase opacity"] = "增加不透明度"
L["<opacity_tooltip>"] = "增加此視窗的不透明度以提高可讀性。"
L["WARNING"] = "警告"
...
--------------------------------------------------------------------------------
L["Field of View"] = "視野"
L["The camera's field of view. Lower values are more zoomed in, higher values show more of your surroundings."] = "鏡頭的視野。較低的值會放大拉近，較高的值會顯示更多周圍環境。"
L["<cameraFov_desc>"] = "視野（FOV）決定了螢幕上一次能顯示多少遊戲世界。較高的視野會顯示更多周圍環境，但會讓一切看起來稍微遠一些；而較低的視野則會拉近畫面，帶來更具電影感的近距離體驗。\n\n透過 DynamicCam 的情境設定，例如可以在跑動時加寬視野，而在與 NPC 互動或戰鬥時縮小視野。"
...
L["<selectedSituation_desc>"] = "\n%s顏色代碼：%s\n%s- 禁用的情境。%s\n%s- 已啟動但目前未啟動的情境。%s\n%s- 啟用且當前啟動的情境。%s\n%s- 啟用且條件滿足但優先順序低於當前啟動情境的情境。%s\n%s- 修改過的原始「情境控制」（建議重置）。%s\n%s- 錯誤的「情境控制」（需要修正）。%s"
...
L["Enter Transition Time"] = "進入過渡時間"
L["The time in seconds for the transition when ENTERING this situation."] = "進入該情境時的過渡時間（秒）。"
L["Exit Transition Time"] = "退出過渡時間"
L["The time in seconds for the transition when EXITING this situation."] = "退出該情境時的過渡時間（秒）。"
...
到目前為止，唯一的例子是「爐石/傳送」情境，其中我們使用 WoW API 函數「UnitCastingInfo()」來確定當前法術的施法持續時間。然後我們將其分配給變數「this.timeToEnter」和「this.timeToEnter」，以便縮放或旋轉（參見「情境指令」）可以正好持續法術施法的時間。（並非所有傳送法術都有相同的施法時間。）
...
L["Current\nZoom\nValue"] = "當前\n縮放\n值"
L["Reactive\nZoom\nTarget"] = "響應\n縮放\n目標"
L["Reactive Zoom"] = "反應式縮放"
L["This graph helps you to\nunderstand how\nReactive Zoom works."] = "此圖表有助於您\n瞭解反應式縮放\n的工作原理。"
...
L["Open the curve editor.\n\nAllows you to define exactly how this setting changes as you zoom in and out. You can add control points to create a custom curve."] = "打開曲線編輯器。\n\n允許您確切定義此設置如何隨縮放而變化。您可以添加控制點來創建自定義曲線。"
L["DynamicCam: Zoom-Based Setting"] = "DynamicCam: 基於縮放的設置"
L["CVAR: "] = "CVAR: "
L["Z\no\no\nm"] = "縮\n放"
L["Value"] = "值"
L["Current Zoom/Value:"] = "當前縮放/值:"
L["Left-click: add/drag point\nRight-click: remove point"] = "左鍵: 添加/拖動點\n右鍵: 刪除點"
L["Copy"] = "複製"
L["<copy_tooltip>"] = "將此曲線複製到剪貼簿。然後可以貼上到任何其他曲線編輯器中，會自動縮放以適應目標值範圍。"
L["Paste"] = "貼上"
L["<paste_tooltip>"] = "用剪貼簿中的曲線替換此曲線，縮放以適應此設定的值範圍。"
L["<paste_disabled_tooltip>"] = "剪貼簿中沒有曲線。請先在曲線編輯器中使用複製。"
L["Revert"] = "還原"
L["<revert_tooltip>"] = "將曲線還原到上次儲存的狀態。"
L["<revert_disabled_tooltip>"] = "沒有未儲存的變更需要還原。"
L["Save"] = "儲存"
L["<save_tooltip>"] = "儲存目前曲線。關閉編輯器時未儲存的變更將遺失。"
L["<save_disabled_tooltip>"] = "沒有未儲存的變更。"
L["Close"] = "關閉"
L["<close_tooltip>"] = "關閉編輯器。所有未儲存的變更將被捨棄。"
