local L = LibStub("AceLocale-3.0"):NewLocale("DynamicCam", "esES") if not L then return end
...
L["<standardSettingsOverridden_desc>"] = "Las categorías marcadas en azul están actualmente anuladas por la situación activa. Por lo tanto, no verás ningún efecto al cambiar los Ajustes Estándar de las categorías azules mientras la situación que las anula esté activa."
L["Currently overridden by the active situation %s."] = "Actualmente anulado por la situación activa %s."
L["Situation disabled."] = "Situación desactivada."
L["Situation enabled but condition not fulfilled."] = "Situación activada, pero condición no cumplida."
L["Situation has a script error."] = "La situación tiene un error de script."
L["Help"] = "Ayuda"
L["Detach"] = "Separar"
L["<detach_tooltip>"] = "Abre los ajustes de DynamicCam en una ventana libremente movible y redimensionable. Así no bloquea el centro de la pantalla mientras realizas ajustes.\n\nTambién puedes escribir /dc en el chat en cualquier momento para abrir esta ventana."
L["<detach_combat>"] = "Durante el combate, no podemos cerrar automáticamente el panel de Opciones del juego.\n\nSiempre puedes abrir la ventana separada escribiendo /dc en el chat."
L["Reattach"] = "Reasociar"
L["<reattach_tooltip>"] = "Cierra esta ventana y abre los ajustes de DynamicCam en el panel de Opciones del juego."
L["<reattach_combat>"] = "Durante el combate, no podemos abrir automáticamente el panel de Opciones del juego."
L["Increase opacity"] = "Aumentar opacidad"
L["<opacity_tooltip>"] = "Aumenta la opacidad de esta ventana para una mejor legibilidad."
...
L["<cameraFov_desc>"] = "El campo de visión (FOV) determina qué parte del mundo del juego es visible en la pantalla al mismo tiempo. Un campo de visión más alto muestra más del entorno, pero hace que todo parezca un poco más lejano, mientras que un campo de visión más bajo se acerca para dar una sensación de primer plano más cinematográfica.\n\nAl usar las situaciones de DynamicCam, puedes, por ejemplo, ampliar el campo de visión mientras corres y reducirlo durante las interacciones con los PNJ o el combate."
...
L["<selectedSituation_desc>"] = "\n%sCódigos de color:%s\n%s- Situación desactivada.%s\n%s- Situación activada pero actualmente inactiva.%s\n%s- Situación activada y actualmente activa.%s\n%s- Situación activada con condición cumplida pero menor prioridad que la situación actualmente activa.%s\n%s- «Controles de situación» originales modificados (se recomienda restablecer).%s\n%s- «Controles de situación» erróneos (se requiere corrección).%s"
...
Puedes aprender sobre los eventos del juego usando la Sesión de evento de WoW.
Para abrirla, escribe esto en la consola:
...
L["Z\no\no\nm"] = "Z\no\no\nm"
L["Value"] = "Valor"
L["Current Zoom/Value:"] = "Zoom/Valor actual:"
L["Left-click: add/drag point\nRight-click: remove point"] = "Clic izq: añadir/arrastrar\nClic dcho: quitar punto"
L["Copy"] = "Copiar"
L["<copy_tooltip>"] = "Copiar esta curva al portapapeles. Luego se puede pegar en cualquier otro editor de curvas, escalándose automáticamente al rango de valores de destino."
L["Paste"] = "Pegar"
L["<paste_tooltip>"] = "Reemplazar esta curva con la del portapapeles, escalada al rango de valores de este ajuste."
L["<paste_disabled_tooltip>"] = "No hay curva en el portapapeles. Usa Copiar en algún editor de curvas primero."
L["Revert"] = "Revertir"
L["<revert_tooltip>"] = "Revertir la curva al último estado guardado."
L["<revert_disabled_tooltip>"] = "No hay cambios sin guardar que revertir."
L["Save"] = "Guardar"
L["<save_tooltip>"] = "Guardar la curva actual. Los cambios sin guardar se pierden al cerrar el editor."
L["<save_disabled_tooltip>"] = "No hay cambios sin guardar."
L["Close"] = "Cerrar"
L["<close_tooltip>"] = "Cerrar el editor. Los cambios sin guardar se descartarán."
...
L["Mounted (only flying-mount + airborne + Skyriding)"] = "Montura (solo voladora + en el aire + surcacielos)"
L["Mounted (only flying-mount + Skyriding)"] = "Montura (solo voladora + surcacielos)"
L["Mounted (only airborne)"] = "Montura (solo en el aire)"
L["Mounted (only airborne + Skyriding)"] = "Montura (solo en el aire + surcacielos)"
L["Mounted (only Skyriding)"] = "Montura (solo surcacielos)"
L["Druid Travel Form"] = "Forma de viaje de druida"
L["Dracthyr Soar"] = "Dracthyr Remontar"
L["Skyriding Race"] = "Carrera de surcacielos"
L["Taxi"] = "Taxi"
L["Vehicle"] = "Vehículo"
