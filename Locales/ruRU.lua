...
L["<standardSettingsOverridden_desc>"] = "Категории, отмеченные синим, в настоящее время переопределяются активной ситуацией. Поэтому изменение стандартных настроек синих категорий не будет иметь эффекта, пока активна переопределяющая ситуация."
L["Currently overridden by the active situation %s."] = "В настоящее время переопределяется активной ситуацией %s."
L["Situation disabled."] = "Ситуация отключена."
L["Situation enabled but condition not fulfilled."] = "Ситуация включена, но условие не выполнено."
L["Situation has a script error."] = "В скрипте ситуации произошла ошибка."
L["Help"] = "Помощь"
L["Detach"] = "Открепить"
L["<detach_tooltip>"] = "Открывает настройки DynamicCam в свободно перемещаемом окне с изменяемым размером. Так окно не блокирует центр экрана, пока вы настраиваете параметры.\n\nВы также можете ввести /dc в чат, чтобы открыть это окно в любой момент."
L["<detach_combat>"] = "Во время боя мы не можем автоматически закрыть панель настроек игры.\n\nВы всегда можете открыть отделённое окно, введя /dc в чат."
L["Reattach"] = "Прикрепить"
L["<reattach_tooltip>"] = "Закрывает это окно и открывает настройки DynamicCam в панели настроек игры."
L["<reattach_combat>"] = "Во время боя мы не можем автоматически открыть панель настроек игры."
L["Increase opacity"] = "Увеличить непрозрачность"
L["<opacity_tooltip>"] = "Увеличивает непрозрачность этого окна для лучшей читаемости."
...
L["The camera's field of view. Lower values are more zoomed in, higher values show more of your surroundings."] = "Поле зрения камеры. Чем ниже значение, тем сильнее приближение; чем выше значение, тем больше окружения попадает в кадр."
L["<cameraFov_desc>"] = "Поле зрения (FOV) определяет, какая часть игрового мира видна на экране одновременно. Более высокое значение FOV показывает больше окружения, но заставляет всё казаться немного дальше, в то время как более низкое значение приближает камеру для более кинематографичного эффекта.\n\nИспользуя ситуации DynamicCam, вы можете, например, расширять FOV во время бега и сужать его при взаимодействии с NPC или в бою."
...
L["<selectedSituation_desc>"] = "\n%sЦветовые коды:%s\n%s- Отключённая ситуация.%s\n%s- Включённая, но в данный момент неактивная ситуация.%s\n%s- Включённая и текущая активная ситуация.%s\n%s- Включённая ситуация с выполненным условием, но с более низким приоритетом, чем текущая активная ситуация.%s\n%s- Изменённые оригинальные «Управления ситуацией» (рекомендуется сброс).%s\n%s- Ошибочные «Управления ситуацией» (требуется исправление).%s"
...
L["Z\no\no\nm"] = "Z\no\no\nm"
L["Value"] = "Значение"
L["Current Zoom/Value:"] = "Тек. масштаб/значение:"
L["Left-click: add/drag point\nRight-click: remove point"] = "ЛКМ: добавить/перетащить\nПКМ: удалить точку"
L["Copy"] = "Копия"
L["<copy_tooltip>"] = "Скопировать эту кривую в буфер обмена. Её можно вставить в любой другой редактор кривых с автоматическим масштабированием под целевой диапазон значений."
L["Paste"] = "Вставка"
L["<paste_tooltip>"] = "Заменить эту кривую кривой из буфера обмена, масштабированной под диапазон значений этой настройки."
L["<paste_disabled_tooltip>"] = "В буфере обмена нет кривой. Сначала используйте Копия в редакторе кривых."
L["Revert"] = "Вернуть"
L["<revert_tooltip>"] = "Вернуть кривую к последнему сохранённому состоянию."
L["<revert_disabled_tooltip>"] = "Нет несохранённых изменений для отмены."
L["Save"] = "Сохранить"
L["<save_tooltip>"] = "Сохранить текущую кривую. Несохранённые изменения будут потеряны при закрытии редактора."
L["<save_disabled_tooltip>"] = "Нет несохранённых изменений."
L["Close"] = "Закрыть"
L["<close_tooltip>"] = "Закрыть редактор. Все несохранённые изменения будут отменены."
