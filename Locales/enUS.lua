...
L["<standardSettingsOverridden_desc>"] = "Categories marked in blue are currently overridden by the active situation. You will thus not see any effect of changing the Standard Settings of blue categories while the overriding situation is active."
L["Currently overridden by the active situation %s."] = "Currently overridden by the active situation %s."
L["Situation disabled."] = "Situation disabled."
L["Situation enabled but condition not fulfilled."] = "Situation enabled but condition not fulfilled."
...
L["Increase opacity"] = "Increase opacity"
L["<opacity_tooltip>"] = "Increase the opacity of this window for better readability."
L["WARNING"] = "WARNING"
...
L["The time in seconds for the transition when ENTERING this situation."] = "The time in seconds for the transition when ENTERING this situation."
L["Exit Transition Time"] = "Exit Transition Time"
L["The time in seconds for the transition when EXITING this situation."] = "The time in seconds for the transition when EXITING this situation."
L["<transitionTime_desc>"] = [[These transition times control how long it takes to transition between situations.

When entering a situation, the "Enter Transition Time" is used for:
  • Zoom transitions (when "Zoom/View" is enabled and NOT restoring a saved zoom)
  • Camera rotations (when "Rotation" is enabled)
    - For "Continuous" rotation: acceleration time to reach rotation speed
    - For "By Degrees" rotation: time to complete the rotation
  • UI fade out (when "Fade Out UI" is enabled)

When exiting a situation, the "Exit Transition Time" is used for:
  • Zoom restoration (when returning to a saved zoom level from "Restore Zoom" settings)
  • Camera rotation exit (when "Rotation" is enabled)
    - For "Continuous" rotation: deceleration time from rotation speed to stop
    - For "By Degrees" rotation with "Rotate Back": time to rotate back
  • Rotating the camera back (when "Rotate Back" is enabled)
  • UI fade in (when "Fade Out UI" was active)

IMPORTANT: When transitioning directly from one situation to another, the NEW situation's Enter Transition Time takes precedence over the old situation's Exit Transition Time for most features (camera rotation, UI fade). However, if zoom is being restored, the OLD situation's Exit Transition Time is used instead. The Exit Transition Time is also used when exiting to no situation.

Note: If you set transition times in the on-enter script using "this.timeToEnter" (see "Situation Controls"), those will override the settings here.]]
...
So far, the only example for this is the "Hearth/Teleport" situation in which we use the WoW API function "UnitCastingInfo()" to determine the cast duration of the current spell. We then assign this to the variables "this.timeToEnter", such that a zoom or rotation (see "Situation Actions") can take exactly as long as the spell cast. (Not all teleport spells have the same cast times.)
...
L["Import"] = "Import"
L["Select the settings you want to export."] = "Select the settings you want to export."
L["Select all and copy the export string below."] = "Select all and copy the export string below."
L["Test view %d"] = "Test view %d"
L["<exportSetView_desc>"] = "You are exporting a Set View. The view configuration is client specific and has to be recreated manually (using Save View) by whoever imports this situation. Please describe below how the importing user should configure the view. Use the \"Test view\" button to switch to your view while writing the description."
L["<import_desc>"] = "If someone shared a DynamicCam situation export string with you, paste it below and hit Accept. The settings it contains then appear as a checkbox tree; tick the ones you want and hit Import to apply them to the situation you currently have selected.\n"
L["Select the settings you want to import."] = "Select the settings you want to import."
L["Paste a situation export string here and hit Accept."] = "Paste a situation export string here and hit Accept."
L["Loaded export from \"%s\". Tick the settings you want and hit Import."] = "Loaded export from \"%s\". Tick the settings you want and hit Import."
L["Imported %d setting(s) into the current situation."] = "Imported %d setting(s) into the current situation."
L["Save current camera to View %d"] = "Save current camera to View %d"
L["<importSetView_desc>"] = "This import includes a Set View. The saved view is client specific, so it cannot be transferred. Recreate it manually: position your camera as described below, then use the button to save it into the imported view slot.\n\nThe exporter's description:"
L["The settings contained in the string are applied to the currently selected situation, overwriting those settings."] = "The settings contained in the string are applied to the currently selected situation, overwriting those settings."
L["Import failed: this is not a valid DynamicCam situation export string."] = "Import failed: this is not a valid DynamicCam situation export string."
...
L["Current\nZoom\nValue"] = "Current\nZoom\nValue"
L["Reactive\nZoom\nTarget"] = "Reactive\nZoom\nTarget"
L["Reactive Zoom"] = "Reactive Zoom"
L["This graph helps you to\nunderstand how\nReactive Zoom works."] = "This graph helps you to\nunderstand how\nReactive Zoom works."
