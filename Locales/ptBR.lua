...
L["<standardSettingsOverridden_desc>"] = "Categorias marcadas em azul estão atualmente substituídas pela situação ativa. Portanto, você não verá nenhum efeito ao alterar as Configurações Base de categorias azuis enquanto a situação de substituição estiver ativa."
L["Currently overridden by the active situation %s."] = "Atualmente substituído pela situação ativa %s."
L["Situation disabled."] = "Situação desativada."
L["Situation enabled but condition not fulfilled."] = "Situação ativada, mas a condição não foi atendida."
...
L["<detach_combat>"] = "Durante o combate, não podemos fechar automaticamente o painel de Opções do jogo.\n\nVocê sempre pode abrir a janela destacada digitando /dc no chat."
L["Reattach"] = "Reanexar"
...
L["<opacity_tooltip>"] = "Aumenta a opacidade desta janela para melhor legibilidade."
L["WARNING"] = "AVISO"
...
L["<selectedSituation_desc>"] = "\n%sCódigos de cores:%s\n%s- Situação desativada.%s\n%s- Situação ativada, mas atualmente inativa.%s\n%s- Situação ativada e atualmente ativa.%s\n%s- Situação ativada com condição atendida, mas prioridade menor que a situação atualmente ativa.%s\n%s- \"Controles de Situação\" originais modificados (redefinição recomendada).%s\n%s- \"Controles de Situação\" errôneos (correção necessária).%s"
