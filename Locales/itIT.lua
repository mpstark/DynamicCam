...
L["<standardSettingsOverridden_desc>"] = "Le categorie contrassegnate in blu sono attualmente sovrascritte dalla situazione attiva. Di conseguenza, non vedrete alcun effetto dalla modifica delle Impostazioni Standard delle categorie blu finché la situazione che le sovrascrive è attiva."
L["Currently overridden by the active situation %s."] = "Attualmente ignorato dalla situazione attiva %s."
L["Situation disabled."] = "Situazione disattivata."
L["Situation enabled but condition not fulfilled."] = "Situazione attivata ma condizione non soddisfatta."
L["Situation has a script error."] = "La situazione ha un errore di script."
L["Help"] = "Aiuto"
L["Detach"] = "Stacca"
L["<detach_tooltip>"] = "Apre le impostazioni di DynamicCam in una finestra liberamente spostabile e ridimensionabile. Così non blocca il centro dello schermo mentre effettui le regolazioni.\n\nPuoi anche digitare /dc nella chat in qualsiasi momento per aprire questa finestra."
L["<detach_combat>"] = "Durante il combattimento, non possiamo chiudere automaticamente il pannello delle Opzioni del gioco.\n\nPuoi sempre aprire la finestra separata digitando /dc nella chat."
L["Reattach"] = "Riattacca"
L["<reattach_tooltip>"] = "Chiude questa finestra e apre le impostazioni di DynamicCam nel pannello delle Opzioni del gioco."
L["<reattach_combat>"] = "Durante il combattimento, non possiamo aprire automaticamente il pannello delle Opzioni del gioco."
L["Increase opacity"] = "Aumenta opacità"
L["<opacity_tooltip>"] = "Aumenta l'opacità di questa finestra per una migliore leggibilità."
...
--------------------------------------------------------------------------------
L["Field of View"] = "Campo visivo"
L["The camera's field of view. Lower values are more zoomed in, higher values show more of your surroundings."] = "Il campo visivo della telecamera. Valori più bassi aumentano lo zoom, valori più alti mostrano una porzione maggiore dell'ambiente circostante."
L["<cameraFov_desc>"] = "Il campo visivo (FOV) determina quale porzione del mondo di gioco è visibile sullo schermo in un dato momento. Un FOV più alto mostra di più l'ambiente circostante ma fa sembrare tutto un po' più lontano, mentre un FOV più basso zooma per un effetto ravvicinato e più cinematografico.\n\nUtilizzando le situazioni di DynamicCam, puoi ad esempio allargare il FOV mentre corri in giro e restringerlo durante le interazioni con i PNG o in combattimento."
...
L["<selectedSituation_desc>"] = "\n%sCodici colore:%s\n%s- Situazione disabilitata.%s\n%s- Situazione abilitata ma attualmente inattiva.%s\n%s- Situazione abilitata e attualmente attiva.%s\n%s- Situazione abilitata con condizione soddisfatta ma priorità inferiore rispetto alla situazione attualmente attiva.%s\n%s- « Controlli situazione » originali modificati (ripristino consigliato).%s\n%s- « Controlli situazione » errati (correzione richiesta).%s"
...
L["Z\no\no\nm"] = "Z\no\no\nm"
L["Value"] = "Valore"
L["Current Zoom/Value:"] = "Zoom/Valore attuale:"
L["Left-click: add/drag point\nRight-click: remove point"] = "Sinistro: aggiungi/sposta\nDestro: rimuovi punto"
L["Copy"] = "Copia"
L["<copy_tooltip>"] = "Copia questa curva negli appunti. Può essere incollata in qualsiasi altro editor di curve, scalandosi automaticamente all'intervallo di valori di destinazione."
L["Paste"] = "Incolla"
L["<paste_tooltip>"] = "Sostituisci questa curva con quella negli appunti, scalata all'intervallo di valori di questa impostazione."
L["<paste_disabled_tooltip>"] = "Nessuna curva negli appunti. Usa prima Copia in un editor di curve."
L["Revert"] = "Ripristina"
L["<revert_tooltip>"] = "Ripristina la curva all'ultimo stato salvato."
L["<revert_disabled_tooltip>"] = "Nessuna modifica non salvata da ripristinare."
L["Save"] = "Salva"
L["<save_tooltip>"] = "Salva la curva attuale. Le modifiche non salvate vengono perse alla chiusura dell'editor."
L["<save_disabled_tooltip>"] = "Nessuna modifica non salvata."
L["Close"] = "Chiudi"
L["<close_tooltip>"] = "Chiudi l'editor. Le modifiche non salvate verranno scartate."
